...
The schematic figures (Extended Data Figures 1–3) are not generated by the
analysis pipeline. Extended Data Figure 2 is the exception to "no source": it is
...
the ISC licence. Extended Data Figures 1 and 3 ship as rendered images only.
